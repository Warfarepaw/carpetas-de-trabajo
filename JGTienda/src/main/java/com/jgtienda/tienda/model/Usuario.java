...
public class Usuario {
	...
	private List<Perfil> idPerfiles;
	
	public void agregarCategoria(Perfil tempPerfiles) 
	{
		
		if(idPerfiles == null) 
		{
			idPerfiles = new LinkedList<Perfil>();
		}
		idPerfiles.add(tempPerfiles);
	}
	
	
	public List<Perfil> getIdPerfiles() {
		return idPerfiles;
	}
	public void setIdPerfiles(List<Perfil> idPerfiles) {
